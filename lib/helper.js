...
function checkPackageVersion() {
    ...
    const packageVersionFromGithub =
        require('https://raw.githubusercontent.com/YoruAkio/GTPS-Backup/main/package.json').version;

    if (packageVersion !== packageVersionFromGithub) {
